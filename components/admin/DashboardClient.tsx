      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button
            size="sm"
            variant="outline"
            className="bg-white border border-[#e1e3e5] text-gray-700 font-medium"
          >
            Export
          </Button>
          ...
          <CardHeader className="flex justify-between items-center px-6 pt-6 pb-0">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Revenue across your selected period
              </p>
            </div>
            <Button
              isIconOnly
          ...
          <CardContent className="px-6 py-4 space-y-4">
            ...
            <div className="p-3 bg-gray-50 rounded-lg">
              ...
              <p className="text-xs text-gray-600 leading-relaxed">
                Add reviews to your products to increase conversion rates by up
                to 15%.
              </p>
              <Button
                size="sm"
                variant="ghost"
                className="text-blue-600 font-bold p-0 mt-2 h-auto text-xs"
              >
                Learn more
              </Button>
            </div>
            ...
            <table className="min-w-full divide-y divide-gray-100">
              <thead>
                <tr className="bg-gray-50/50">
                  <th className="px-6 py-3 text-left text-[10px] font-bold uppercase tracking-wider text-gray-500">
                    Order
                  </th>
                  <th className="px-6 py-3 text-left text-[10px] font-bold uppercase tracking-wider text-gray-500">
                    Date
