...
export function Icon({ icon, className }: { icon: ThemeIconName; className?: string }) {
  ...
  switch (icon) {
    ...
    case 'nav':
      return (
        <svg className={iconClass} role="presentation" viewBox="0 0 18 12" fill="currentColor">
    ...
    case 'nav-desktop':
      return (
        <svg className={iconClass} role="presentation" viewBox="0 0 22 16" fill="currentColor">
    ...
    case 'heart':
      return (
        <svg className={iconClass} role="presentation" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    case 'twitter':
      return (
        <svg className={iconClass} role="presentation" viewBox="0 0 24 24" fill="currentColor">
