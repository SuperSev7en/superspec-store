...
export async function FeaturedCollections({
  ...
  const layoutMode = typeof settings.layout_mode === 'string' ? settings.layout_mode : 'grid';
  ...
  return <FeaturedCollectionsClient id={id} sectionTitle={sectionTitle} tabs={tabs} />;
}
