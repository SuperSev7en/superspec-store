export function Marquee({
  ...
  const backgroundColor = typeof settings.background_color === 'string' ? settings.background_color : '#000000';
  const textColor = typeof settings.text_color === 'string' ? settings.text_color : '#ffffff';

  if (!text) return null;

  return (
    <section id={`section-${id}`} data-section-id={id} data-section-type="marquee">
      <div 
