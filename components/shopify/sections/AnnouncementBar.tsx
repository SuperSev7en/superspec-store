...
export function AnnouncementBar({
  ...
  const background = typeof settings.background === 'string' ? settings.background : '#000000';
  ...
  return (
    <>
      <section id={`section-${id}`} data-section-id={id} data-section-type="announcement-bar">
