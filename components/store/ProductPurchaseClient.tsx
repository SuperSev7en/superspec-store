  ...
  return (
    <>
      <div className="ProductMeta__PriceList Heading">
        {onSale ? (
          <span
            className="ProductMeta__Price ProductMeta__Price--compareAt Text--subdued"
            style={{ textDecoration: "line-through", marginRight: 10 }}
          >
            ${Number(selected.compareAtPrice).toFixed(2)}
          </span>
        ) : null}
        <span className="ProductMeta__Price Price Text--subdued">
      ...
      <div className="ProductForm">
        ...
        <div
          className="ProductForm__AddToCart"
          style={{ marginTop: safe.length > 1 ? 20 : 0 }}
        >
          <AddToCartButton
            handle={handle}
