      ...
      >
        ...
        {submitted ? (
          <div style={{ textAlign: "center" }}>
            ...
            <h2 className="Heading u-h3" style={{ marginBottom: 8 }}>
              You're in!
            </h2>
            <p className="Text--subdued">
              Check your email for your 10% off code. Use it on your first
              order.
            </p>
          </div>
        ) : (
          <>
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              ...
              <h2 className="Heading u-h2" style={{ marginBottom: 8 }}>
                Wait — 10% off your first order
              </h2>
              <p className="Text--subdued" style={{ fontSize: 15 }}>
                Join the SUPER Spec list for early access to drops, exclusive
                pieces, and your welcome discount.
              </p>
            </div>
            <form
