...
export function ArtOverlay({
  ...
  const isDigital = product.tags.some((t) =>
    t.toLowerCase().includes("digital"),
  );
  const isOriginal = product.tags.some((t) =>
    t.toLowerCase().includes("original"),
  );
    ...
    <div className="ArtOverlay">
      ...
      {isOriginal ? (
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          >
            Limited Edition — {stock} remaining
          </span>
        </div>
      ) : null}
        ...
        >
          <input
            ...
            onChange={(e) => {
              ...
              if (e.target.checked)
                toast("Framing will be added to your order");
            }}
            style={{ marginTop: 4, width: 18, height: 18 }}
          />
          <div>
            <label
              htmlFor="framing-upsell"
              className="Heading u-h6"
              style={{ display: "block", cursor: "pointer" }}
            >
              Add custom framing (+$45)
            </label>
            <p
              className="Text--subdued"
              style={{ fontSize: 13, margin: "4px 0 0" }}
            >
              Museum-quality matte black gallery frame with UV-protective
              acrylic glass. Ships fully assembled and ready to hang.
            </p>
          </div>
        </div>
      )}
      ...
      {isDigital && (
        ...
        >
          ...
          Digital download delivered via email instantly after purchase. No
      ...
      >
        ...
        {showStatement && (
          <div
            ...
            style={{ paddingBottom: 16, fontSize: 14 }}
          >
            <p>
              &quot;This series explores the intersection of digital spectrums
              and organic forms. By constraining the palette and heavily
              manipulating the focal points, I aim to create a sense of
              manufactured serendipity. Each print is carefully produced to
              ensure the vibrant neon highlights pop against the deep, absorbent
              blacks of the archival paper.&quot;
            </p>
          </div>
        )}
      </div>
