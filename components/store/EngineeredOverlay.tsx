...
export function EngineeredOverlay({
  ...
  const technicalSpecs = p.metafields?.technical_specs || {
  ...
  const leadTime =
    p.metafields?.lead_time || "Ships in 5-7 business days";
  const compatibility =
    p.metafields?.compatibility_notes ||
    'Compatible with all standard 1/4"-20 mounting systems.';
  const specSheetUrl =
    p.metafields?.spec_sheet_url || "/assets/dummy-spec-sheet.pdf";
  ...
  return (
    <div className="EngineeredOverlay">
      ...
      >
        ...
        >
          <h4 className="Heading u-h7" style={{ marginBottom: 8 }}>
            Material Highlight
          </h4>
          <p className="Text--subdued" style={{ fontSize: 13, margin: 0 }}>
            Machined from solid billets of 6061 Aluminum for maximum
        ...
        >
          <span
            className="Heading u-h7 text-green-600"
            style={{
              display: "flex",
              alignItems: "center",
              gap: 6,
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        >
          <h3 className="Heading u-h5" style={{ margin: 0 }}>
          ...
          >
            ...
            <div style={{ marginBottom: 12 }}>
              <textarea
                className="Form__Input"
                rows={4}
                placeholder="What do you need to know about this product?"
                required
              ></textarea>
            </div>
            <button
