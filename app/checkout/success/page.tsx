...
export default async function CheckoutSuccessPage({
  ...
  let detail: string | null =
    "Your payment was received. You will get a confirmation email from Stripe shortly.";
  ...
  if (session_id) {
    try {
      ...
      if (session.payment_status === "paid") {
        ...
        detail =
          "If you used a delayed payment method, your order will finalize when the payment clears.";
      }
    } catch {
      detail =
        "If you completed checkout, your order is on its way. Keep the Stripe receipt email for your records.";
    }
  }
