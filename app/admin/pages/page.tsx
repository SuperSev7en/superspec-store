...
const SYSTEM_PAGES: Page[] = [
  {
    ...
    title: "About",
    slug: "about",
    body: "<h1>About SUPER Spec</h1><p>We build products that refuse to compromise...</p>",
    published: true,
  ...
  },
  {
    ...
    slug: "shipping",
    body: "<h1>Shipping</h1><p>Free shipping over $75. Orders ship within 2 business days.</p>",
    published: true,
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    title: "Returns",
    slug: "returns",
    body: "<h1>Returns</h1><p>Free returns within 30 days.</p>",
    published: true,
    updatedAt: new Date().toISOString(),
  },
  {
          ...
          <div className="col-span-2 space-y-4">
                ...
                onChange={(e) =>
                  setEditing((p) =>
                    p
                      ? {
                          ...p,
                          title: p.id ? p.title : e.target.value,
            ...
            <div>
              ...
              <textarea
                value={editing.body}
                onChange={(e) =>
                  setEditing((p) => (p ? { ...p, body: e.target.value } : null))
                }
              ...
              <p className="text-xs text-gray-500 mt-1">
                HTML is supported. In production, swap for TipTap rich-text
                editor.
              </p>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditing((p) =>
                        p ? { ...p, slug: slugify(e.target.value) } : null,
                      )
                    }
                    className="flex-1 border border-gray-200 rounded px-2 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-gray-900"
                  />
                </div>
              </div>
              <div>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      setEditing((p) =>
                        p ? { ...p, published: e.target.checked } : null,
                      )
                    }
                    className="w-4 h-4"
                  />
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditing((p) =>
                      p ? { ...p, metaTitle: e.target.value } : null,
                    )
                  }
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setEditing((p) =>
                      p ? { ...p, metaDesc: e.target.value } : null,
                    )
                  }
                  className="w-full border border-gray-200 rounded px-2 py-1.5 text-xs"
                  rows={3}
        ...
        {pages.map((page) => (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span
                className={`ml-2 text-xs px-2 py-0.5 rounded-full font-semibold ${page.published ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-500"}`}
              >
