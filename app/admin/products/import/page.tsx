  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <p className="text-sm text-gray-600">
        Upload a Shopify product export CSV. This will upsert products by{" "}
        <code>Handle</code> and replace variants per product (MVP). Images are
        handled separately via the Media uploader on each product.
      </p>
      ...
      <div className="bg-white shadow rounded-lg p-6 space-y-2">
        ...
        <p className="text-sm text-gray-600">
          Download a Shopify-ish CSV from your current Supabase catalog.
        </p>
        <a
