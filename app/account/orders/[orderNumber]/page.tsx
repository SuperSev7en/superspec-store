...
export default function OrderDetailPage({
  ...
  return (
    <div>
      ...
      >
        <div>
          <h1 className="Heading u-h2" style={{ marginBottom: 6 }}>
                ...
                <div
                  style={{
                    ...
                    background: done
                      ? "var(--text-color)"
                      : "var(--border-color)",
                    color: done ? "var(--background)" : "transparent",
                    display: "flex",
                    alignItems: "center",
      ...
      <div style={{ display: "flex", gap: 32, flexWrap: "wrap" }}>
        ...
        <div style={{ flex: "1 1 400px" }}>
          <h2 className="Heading u-h5" style={{ marginBottom: 16 }}>
            Items
          </h2>
        ...
        >
          {order.shipping_address && (
            <div>
              <h3 className="Heading u-h6" style={{ marginBottom: 10 }}>
                Shipping Address
              </h3>
              <div
                className="Text--subdued"
