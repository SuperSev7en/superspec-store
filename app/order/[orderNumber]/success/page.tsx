  ...
  return (
    ...
    >
      <div style={{ textAlign: "center", marginBottom: 50 }}>
        ...
        <p className="Text--subdued" style={{ fontSize: 16, marginTop: 10 }}>
          Order #{orderNumber || "PENDING"}
        </p>
        <p className="Text--subdued" style={{ marginTop: 5 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          {cart.map((item, i) => (
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <p className="Heading u-h6" style={{ margin: 0 }}>
                  {item.title}
                </p>
                {item.variantTitle && (
                  <p
      ...
      <div
        style={{ display: "flex", flexWrap: "wrap", gap: 40, marginBottom: 50 }}
      >
        ...
        <div style={{ flex: 1, minWidth: 250 }}>
          ...
          <p className="Text--subdued" style={{ marginBottom: 15 }}>
            Show off your new piece and tag us @superspec.studio
          </p>
      ...
      <div style={{ textAlign: "center" }}>
        <Link href="/collections/all" className="Button Button--primary">
          Continue Shopping
        </Link>
      </div>
    </div>
